 ...
 */
function getRetreatDisabledReason(card: GameCard, hasBench: boolean, retreatedThisTurn: boolean): string | null {
...
export function ActiveSpot({
  ...
  const retreatDisabledReason = card && !isOpponent ? getRetreatDisabledReason(card, hasBench, retreatedThisTurn) : null;
